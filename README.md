...
| `packages/claude-plugin` | Claude Code and Cursor Plugin package — manifests, commands, agents, skills, hooks, MCP registration |
...
`packages/claude-plugin` (Cursor), or register `packages/codex-plugin` (Codex).
