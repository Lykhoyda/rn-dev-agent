...
show the complete sanitized typed bundle during review before attaching it; do
not substitute raw runner output. Reconcile its authority object with the previously
