---
name: proof-capture
description: "Explicit Codex workflow: Capture PR-ready proof artifacts for a feature. Use --strict for a fail-closed proof_capture receipt; omit it for the interactive video, screenshots, and PR-body workflow."
---
<!-- GENERATED by scripts/build-host-runtimes.ts from packages/shared-agent-knowledge/source-map.json. DO NOT EDIT. -->

# proof-capture

Invoke this workflow explicitly as `$rn-dev-agent:proof-capture [request text]`.
