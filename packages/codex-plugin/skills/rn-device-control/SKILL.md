...
| Persistent E2E test file | `maestro_run` / `cdp_run_action` (YAML) | Exact `1.1.24` pin-cache replay with CI-ready artifacts |
...
- **Whole-flow E2E** → rn-dev-agent replay tools with the exact pin-cache maestro-runner (`.yaml`).
