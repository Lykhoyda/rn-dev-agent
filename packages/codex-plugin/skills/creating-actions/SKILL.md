...
- A fresh fenced session starts revision 1 with empty run and repair history. Revisions and promotion history do not cross session boundaries; promotion earned in one session is invisible to the next by design.
