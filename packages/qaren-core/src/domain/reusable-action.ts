...
//
// YAML stays in <project>/.qaren/actions; mutable state follows the current
// session state directory, with .qaren/state as the unfenced fallback.
//
 ...
 *   imported  — landed from a foreign corpus (foreign provenance)
 */
