...
`codex-skills/rn-best-practices/rules.index.json`. Do NOT read all 118 rule files;
...
' codex-skills/rn-best-practices/rules.index.json
...
These are described inline in `codex-skills/rn-best-practices/SKILL.md` for fast
...
- `[VERCEL/rn-dev-agent/navigation-transparent-modal] Bridgeless `transparentModal` routing failure — HIGH (confidence 95) — upstream: codex-skills/rn-best-practices/references/rn-dev-agent/navigation-transparent-modal.md`
