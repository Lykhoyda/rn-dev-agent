...
lives in `codex-skills/rn-best-practices/rules.index.json`. Do NOT scan all 118
...
`jq '[.[] | .triggers[]] | unique' codex-skills/rn-best-practices/rules.index.json`.
...
```
Rules consulted (from codex-skills/rn-best-practices/rules.index.json):
...
These are described inline in `codex-skills/rn-best-practices/SKILL.md`. The full
