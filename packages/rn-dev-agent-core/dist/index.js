...
import { createMirrorSource, IosSimctlLoopSource, idbDemotionHint, } from './observability/mirror/sources.js';
...
const makeReplayDeps = (_args, signal) => {
...
const probeNativeVision = async ({ deviceId, selectors, signal, }) => {
