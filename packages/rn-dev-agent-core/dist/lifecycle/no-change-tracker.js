...
export const WEDGED_RUNTIME_HINT = `${WEDGED_DISTINCT_TARGETS} consecutive taps on distinct targets produced no UI change — ` +
...
const streak = [];
export function recordNoUiChange(targetKey) {
...
export function _resetNoChangeStreakForTest() {
    streak.length = 0;
}
