...
export function candidateRecordScripts(baseDir = dirname(fileURLToPath(import.meta.url))) {
...
export function resolveRecordScript(baseDir = dirname(fileURLToPath(import.meta.url))) {
