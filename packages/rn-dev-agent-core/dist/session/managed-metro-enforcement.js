...
export function prepareManagedMetroEnforcement(input, dependencies = {}) {
    ...
    return {
        ...
        port: input.port,
        unallocatedPort: input.port === 65_535 ? input.port - 1 : input.port + 1,
        nodeExecutable,
    };
}
...
export function runManagedMetroEnforcementPreflight(plan, dependencies = {}) {
    ...
    try {
        ...
        if (observed.processCreationDenied !== true ||
...
export function verifyManagedMetroEnforcementReceipt(input, receipt) {
