#!/usr/bin/env node
/**
 * Measure MCP tool description weight in packages/rn-dev-agent-core/src/index.ts.
 *
 * Usage:
 *   node packages/rn-dev-agent-core/measure-tool-descriptions.mjs
 *   node packages/rn-dev-agent-core/measure-tool-descriptions.mjs --json
 *   node packages/rn-dev-agent-core/measure-tool-descriptions.mjs --save
 *
...
const summary = {
  ...
  source: 'packages/rn-dev-agent-core/src/index.ts',
