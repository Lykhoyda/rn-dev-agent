...
test('strict proof rejects any recording saved outside the declared mp4 path', async (t) => {
  for (const scenario of [
    ...
    { path: beginArgs().videoPath.replace(/\.mp4$/, '.mov'), skipped: 'ffmpeg unavailable' },
    {
