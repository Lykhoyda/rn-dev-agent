...
All YAML replay uses rn-dev-agent's tools and pin-cache maestro-runner `>= 1.1.27`
(attested 1.1.27 is the default known-good). Missing, older, unverified, checksum-mismatched,
