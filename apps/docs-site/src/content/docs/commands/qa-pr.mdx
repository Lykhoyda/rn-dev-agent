...
| 6a | Feature proof: usable screen, real path recorded, action saved or reused, off-camera rehearsal, video started before the runner, `maestro_run` take, validation |
