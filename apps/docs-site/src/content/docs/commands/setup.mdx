...
| Phase | Step | Action |
|---|---|---|
| 1. Diagnose | A | Run [`/doctor`](../doctor/) — check Node, CDP bridge, device runner (rn-fast-runner iOS / rn-android-runner Android), maestro-runner, simulators, Metro, ffmpeg |
