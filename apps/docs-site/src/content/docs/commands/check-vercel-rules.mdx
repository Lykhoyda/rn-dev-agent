...
The checker and rules index ship inside the installed plugin package both hosts
share, so installed Codex workflows do not depend on an rn-dev-agent source
checkout. Each violation cites
