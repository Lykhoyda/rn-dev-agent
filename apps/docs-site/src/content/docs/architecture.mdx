...
| **E2E testing** | maestro-runner `>= 1.1.27` (versioned pin-cache only; attested 1.1.27 default) | YAML-based persistent test files; underlying format for actions in `.rn-agent/actions/` |
