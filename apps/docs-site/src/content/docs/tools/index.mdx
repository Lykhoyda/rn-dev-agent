---
title: MCP Tools
description: MCP tools for React Native development — CDP introspection, device interaction, actions, testing, and macro-asserts.
---

The MCP server exposes tools organized into five conceptual families. All tools are available through Claude Code's tool-calling interface.
