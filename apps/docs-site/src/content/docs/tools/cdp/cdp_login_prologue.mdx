...
description: "User-login helper: replay the exact user-login action and return its fresh passing RunRecord; it fails like any other replay, and a pass is not PR proof"
---
