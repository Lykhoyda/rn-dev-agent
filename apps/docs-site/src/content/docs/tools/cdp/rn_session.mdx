...
|------|------|----------|---------|-------------|-------------|
| `action` | `enum: status | bind_device | bind_metro | pin_dev_client | prepare_handoff | cancel_handoff | accept_handoff | adopt_stale | recover_arbiter | preview_integration | apply_integration | restore_integration | stop_metro | release` | Yes |  |  |  |
