...
// D1209 — render the parsed produces map as a compact table cell. Uses
// `key=value` separated by `, ` for readability (the M7 header source
// uses YAML's `key: value` shape; the cell variant trades that for
// scanability when 5+ keys land in one row). Empty / null returns '?'.
