...
// RN_PLUGIN_VERSION var alone never reached the runner. buildRunnerVersionEnv
// emits both forms so the plain var still works for any direct launch path.
import { test } from 'node:test';
import assert from 'node:assert/strict';
import { buildRunnerVersionEnv } from '../../dist/runners/rn-fast-runner-client.js';
