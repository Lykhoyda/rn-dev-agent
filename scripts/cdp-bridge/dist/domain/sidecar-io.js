 ...
 */
export function loadOrInitSidecar(yamlFilePath, now = () => new Date()) {
 ...
 */
export function saveSidecar(yamlFilePath, state) {
    const path = sidecarPathFor(yamlFilePath);
 ...
 * a human edit.
 */
export function yamlEditedSinceLastSeen(yamlFilePath, state) {
    try {
...
export function markSeen(state, mtimeMs) {
