#!/usr/bin/env bash
# CI gate: the committed compiled MCP server and packaged Codex runtime must
...
CODEX_RUNTIME_BUILD_CMD="${CODEX_RUNTIME_BUILD_CMD:-node scripts/build-codex-runtime.ts}"
