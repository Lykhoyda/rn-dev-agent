...
| [07](07-native-first-replay.md) | Native-first action replay (Maestro YAML as interchange) — **POSTPONED (D1290)**, escalation path only | Unblocks iOS 26; removes WDA from critical path | L | 04, 05 |
...
| [13](13-maestro-runner-seamless-integration.md) | Seamless maestro-runner (Go) integration — near-term replay direction (replaces 07 per D1290) | Version pinning, blind-probe fast-path, wider fallback grammar, keyboard seam, iteration speed | M | — (absorbs #334, #240) |

## Suggested sequencing

```
Wave 1 (independent, start anytime):  01, 02, 03, 08, 11, 13 (Phases 1-2)
Wave 2 (builds on wave 1):            04 (needs 02 capabilities), 06 (needs 01), 09 (needs 02), 13 (Phases 3-5)
Wave 3:                               05 (needs 04), 10 (needs 04)
Wave 4 (the strategic ones):          12 (needs 06 Phase C evals as the safety gate)
Escalation only (postponed, D1290):   07 (needs 04+05) — resume if the Story 13 fallback fence keeps moving
```
