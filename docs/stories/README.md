...
| [07](07-native-first-replay.md) | Native-first action replay (Maestro YAML as interchange) — **POSTPONED (D1291)**, escalation path only | Unblocks iOS 26; removes WDA from critical path | L | 04, 05 |
...
Escalation only (postponed, D1291):   07 (needs 04+05) — resume if the Story 13 fallback fence keeps moving
```
