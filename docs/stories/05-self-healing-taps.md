...
**Status:** Implemented (2026-07-04, #386); the still-unchanged outcome below is superseded on Android by #736 — see the interaction reliability table in `CLAUDE-MD-TEMPLATE.md`
